...
export default function P(){const router=useRouter();const sb=createBrowserClient();const[step,setStep]=useState<Step>('username');const[loading,setLoading]=useState(false);const[type,setType]=useState('');const[topics,setTopics]=useState<string[]>([]);const[optIn,setOptIn]=useState(false);const[provider,setProvider]=useState('')
