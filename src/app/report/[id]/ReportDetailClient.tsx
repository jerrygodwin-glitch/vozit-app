...
<div style={{height:200,background:'#0a1e30',display:'flex',alignItems:'center',justifyContent:'center'}}>{r.playback_id?<div>Video</div>:<span style={{color:'rgba(255,255,255,0.2)'}}>Video processing...</span>}</div>
...
<div style={{display:'flex',gap:8,marginBottom:14}}><div style={{flex:1,padding:10,borderRadius:8,border:'1px solid #eee',textAlign:'center',cursor:'pointer',fontSize:11,fontWeight:600,color:'#555'}}>X</div><div style={{flex:1,padding:10,borderRadius:8,border:'1px solid #eee',textAlign:'center',cursor:'pointer',fontSize:11,fontWeight:600,color:'#555'}}>Facebook</div><div style={{flex:1,padding:10,borderRadius:8,border:'1px solid #eee',textAlign:'center',cursor:'pointer',fontSize:11,fontWeight:600,color:'#555'}}>Copy link</div></div>
</div></div>)}
